...
def decode(k, dkey, code):
    if k == dkey:
        ...
        messagebox.showerror('SAFE', 'INVALID SECRETE KEY. Try again.')
        return ""
...
def result():
    ...
    if i == 1:
        ...
        messagebox.showinfo('SAFE', 'Please fill the fields. Try again.')
    else:
        messagebox.showinfo('SAFE', 'Please Choose Encryption. Try again.')
...
def d_result():
    ...
    if i == 2:
        ...
        messagebox.showinfo('SAFE', 'Please Choose Decryption . Try again.')
...
headingFrame1 = LabelFrame(window, bg="gray91", bd=5, text='Encipher')
headingFrame1.grid(column=2, row=1, pady=10, padx=30)

headingLabel = Label(window, text="SAFE Encryption and Decryption System",
...
label3 = Label(headingFrame1, text='Check this encrypt ', font=('Courier', 10, 'bold'))
label3.grid(column=1, row=5, padx=10, pady=10)

Radiobutton(headingFrame1, text='Encrypt', variable=mode, value=1).grid(column=1, row=6, padx=5, pady=5)
...
d_label2 = Label(decipher, text='Enter Secret key', font=('Courier', 10, 'bold'))
...
d_label3 = Label(decipher, text='Check this to decrypt', font=('Courier', 10, 'bold'))
...
d_label3 = Label(decipher, text='Pain text', font=('Courier', 10, 'bold'))
